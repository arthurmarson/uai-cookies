...
import { getSiteInfo, getWhatsAppUrl, getFaq } from "@/lib/content";
...
export const metadata: Metadata = {
  title: "Contato — Uai Cookies",
  description:
    "Entre em contato com a Uai Cookies pelo WhatsApp ou Instagram. Confira horários, área de entrega e perguntas frequentes.",
};

export default function Contato() {
  const site = getSiteInfo();
  const whatsappUrl = getWhatsAppUrl("Olá! Vim pelo site e gostaria de saber mais 🍪");
