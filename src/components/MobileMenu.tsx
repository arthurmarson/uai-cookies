...
export function MobileMenu({
  ...
  return (
    <div
      className={`fixed inset-0 z-50 flex flex-col items-center justify-center bg-marrom-dark/95 transition-opacity duration-250 motion-reduce:transition-none ${
        isOpen
    ...
    >
      <button
        ref={closeRef}
        onClick={onClose}
        className="absolute top-4 right-4 p-2 text-creme hover:text-caramelo transition-colors cursor-pointer"
